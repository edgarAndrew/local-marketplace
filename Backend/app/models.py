...
class ProductModel(BaseModel):
    ...
    fuel = models.CharField(choices=FUEL, max_length=50, default=FUEL[0], null=True, blank=True)
    km_driven = models.PositiveIntegerField(null=True, blank=True)
    transmission_type = models.CharField(choices=TRANSMISSION, max_length=50, default=TRANSMISSION[0], null=True, blank=True)
    property_type = models.CharField(choices=PROPERTIES, max_length=50, default=PROPERTIES[0], null=True, blank=True)
...
class ProductImagesModel(BaseModel):
    product = models.ForeignKey(ProductModel, related_name="product_image", on_delete=models.CASCADE)
